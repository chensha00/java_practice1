...
-- 物流信息表
-- 主键，物流单号，物流生成时间，物流状态，订单信息外键，物流信息表，发货人电话，发货地址，收货人姓名，收货人电话，收货人地址
-- 备注信息，用户评星，用户评价内容，
CREATE TABLE LOGISTICS_INFO(
	ID BIGINT PRIMARY KEY AUTO_INCREMENT COMMENT '主键',
	LOGISTICS_NUM VARCHAR(30) NOT NULL UNIQUE COMMENT '物流单号',
	LOGISTICS_TIME DATETIME  DEFAULT NULL COMMENT '物流生成时间  yyyy-MM-dd HH:mm:ss',
	...
	MESSAGE VARCHAR(100) DEFAULT NULL COMMENT'备注信息',
	USER_STAR TINYINT(2) DEFAULT NULL COMMENT'用户评星 1-5 颗星 1-极差 2-差 3-一般 4-良 5-优',
	USER_COMMENT VARCHAR(100) DEFAULT NULL COMMENT'用户评价内容',
...
-- 物流过程
-- 主键，物流信息表，经过顺序，到达时间时间，到达地址，备注信息
CREATE TABLE LOGISTICS_GOBY(
	ID BIGINT PRIMARY KEY AUTO_INCREMENT COMMENT '主键',
	LOGISTICS_INFO_ID BIGINT NOT NULL COMMENT'物流信息表 外键',
	GOBY_ORDERBY TINYINT(2) COMMENT'经过顺序',
	GOBY_TIME DATETIME  DEFAULT NULL COMMENT '到达时间时间  yyyy-MM-dd HH:mm:ss',
	GOBY_ADDRESS VARCHAR(100) COMMENT'到达地址',
	MESSAGE VARCHAR(100) DEFAULT NULL COMMENT'备注信息',
