...
public class InvertoryDaoImpl extends BaseDaoImpl<Invertory> implements InvertoryDao {
     ...
     */
    @Override
    public Integer updateInvertorById(Long id, Invertory inventory) throws SQLException {
        Map map=new HashMap();
     ...
     */
    @Override
    public Invertory findInventoryByStoreIdAndGoodsId(Long storeId, Long goodsId) {
        Map map = new HashMap();
     ...
     * @throw SQLException
     */
    public List<Invertory> findInventoryByUnSureCondition(List<Map<String, Object>> map)
            throws SQLException {
