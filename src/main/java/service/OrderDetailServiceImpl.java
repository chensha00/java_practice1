...
//
//        orderDetail=orderDetailDao.findOrderDetailById(id).get(0);
//
//        return orderDetail;
        ...
        try {
            ...
            orderDetail = orderDetailDao.findOrderDetailById(id, conn, preparedStatement);
            ...
            //保存商铺信息根据指定id
            if (orderDetail != null) {
                orderDetail.setStore(new StoreServiceImpl().findStoreById(orderDetail.getStoreId()));
            }
            //返回商品对象
            return orderDetail;
        }
