...
<div id="all_div" align="center">
    <table align="center" border="1" class="table_update_store">
        ...
        <tr>
            <td>ID</td>
            <td><input type="text" class="store_id" value="${updStore.id}"/></td>
        </tr>
        <tr>
            <td>STORE_NUM</td>
            <td><input type="text" class="store_store_num" value="${updStore.storeNum}"/></td>
        </tr>
        <tr>
            <td>STORE_NAME</td>
            <td><input type="text" class="store_store_name" value="${updStore.storeName}"/></td>
        </tr>
        <tr>
            <td>CREDIT</td>
            <td><input type="text" class="store_credit" value="${updStore.credit}"/></td>
        </tr>
        <tr>
            <td>PEOPLE_ID</td>
            <td><input type="text" class="store_people_id" value="${updStore.peopleId}"/></td>
        </tr>
        <tr>
            <td colspan="2" align="center"><button id="upd_store_btn">确认修改</button> </td>
        </tr>
        </tbody>
    </table>
</div>
...
<script type="text/javascript">
    $("#upd_store_btn").click(function(){
        ...
        $.ajax({
            ...
            data:{storeId:id,storeNum:storeNum,storeName:storeName,credit:credit,peopleId:peopleId},
            dataType:'json',
            success:function(){
